...
(function () {
    ...
    function renderTeacherSignupCta() {
        ...
        link.href = 'https://www.esheets.io/#/portal/signup';
        link.textContent = 'Sign up and set this worksheet as self-marking homework.';
        link.target = '_blank';
        ...
        if (targetEl === topScoreBar) {
            targetEl.parentNode.insertBefore(cta, targetEl.nextSibling);
        } else {
